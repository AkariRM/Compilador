...
public class AnalizadorSintactico {
	...
	private static final String[] TERMINALES = { "id", "num", "litcad", "litc", "true", "false", "(", ")", "!", "*",
			"/", "+", "-", "<", ">", "<=", ">=", "==", "!=", "&&", "||", "$" };

	// No terminales en el orden exacto de las filas de la tabla
	private static final String[] NO_TERMINALES = { "L", "L'", "R", "R'", "E", "E'", "T", "T'", "F" };

	// Tabla predictiva como arreglo bidimensional
