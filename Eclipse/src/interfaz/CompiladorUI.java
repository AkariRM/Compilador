...
public class CompiladorUI {
	...
	public void CrearMostrar() {
		...
		analizar.addActionListener(e -> areaComponentes.setText("Analizando..."));
		...
		compilar.addActionListener(e -> areaComponentes.setText("Compilando..."));
		...
		botonCompilar.addActionListener(e -> areaComponentes.setText("Compilando..."));
		...
		panelPrincipal.add(desplazamientoComponentes, restricciones);
	...
	private void guardarArchivoComo() {
	    ...
	    selectorArchivos.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("Archivos ARM (*.arm)", "arm"));
	...
	private void escribirEnArchivo(File archivo) {
		try (BufferedWriter escritor = new BufferedWriter(new FileWriter(archivo))) {
			...
			JOptionPane.showMessageDialog(null, "Archivo guardado correctamente", "Que Eficiente",
					JOptionPane.INFORMATION_MESSAGE);
			actualizarTitulo();
		} catch (IOException e) {
			JOptionPane.showMessageDialog(null, "Error al guardar el archivo", "Algo malio sal..",
